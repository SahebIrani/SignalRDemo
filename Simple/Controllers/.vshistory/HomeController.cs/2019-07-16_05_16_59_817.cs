...
namespace Simple.Controllers
{
	public class HomeController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			await HubContextSignalServer.Clients.All.SendAsync("Notify2", $"Home page loaded at: {DateTime.Now}");
			return View();
		}

		public async Task<IActionResult> GetEmployeesAsync()
		{
			await HubContextSignalServer.Clients.All.SendAsync("Notify", $"Home page loaded at: {DateTime.Now}");
